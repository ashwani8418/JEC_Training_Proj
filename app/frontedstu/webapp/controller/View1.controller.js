sap.ui.define([
    ...
    function (Controller, Dialog, Button) {
        ...
        return Controller.extend("com.ingex.frontedstu.controller.View1", {
            ...
            onUpdateSave: async function (oEvent) {
                try {
                    let index = oEvent.getSource(); // Get the source object of the event
                    ...
                    oBusyDialog.open(); // Open busy dialog

                    let oModel3 = this.getOwnerComponent().getModel(); // Get model instance
                    ...
                    let oBindList3 = oModel3.bindList("/StudentInfo", null, null, [aFilter]);

                    // Request the contexts that match the filter
                    let res = await oBindList3.requestContexts().then(function (aContexts) {
            ...
            onDeleteRecordPress: async function (oEvent) {
                try {
                    ...
                    let ID = oContext.getProperty("ID");
